...
export const HeroContainer = ({ className, ...rest }) => (
...
export const HeroBackground = ({ opacity = 0.7, className, ...rest }) => {
...
export const HeroImage = ({ className, alt, ...rest }) => (
  <div className={classes(styles.image, className)}>
    <Image reveal alt={alt} delay={300} {...rest} />
  </div>
);

export const HeroSectionContent = ({ className, width = 'l', ...rest }) => (
  <div
...
export const HeroSectionHeading = ({ className, level = 3, as = 'h2', ...rest }) => (
  <Heading
...
export const HeroSectionColumns = ({ className, centered, ...rest }) => (
  <HeroSectionContent
